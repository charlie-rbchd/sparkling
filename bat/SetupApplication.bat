...
:: Android packaging
set AND_CERT_NAME="LudumDare27"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\LudumDare27.p12
...
set IOS_PROVISION=cert\LudumDare27.mobileprovision
...
set APP_ID=air.LudumDare27

:: Output packages
set DIST_PATH=dist
set DIST_NAME=LudumDare27
